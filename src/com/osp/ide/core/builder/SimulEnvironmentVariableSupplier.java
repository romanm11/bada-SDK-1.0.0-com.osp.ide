 ...
 *
 */
public class SimulEnvironmentVariableSupplier implements
	...
	public IBuildEnvironmentVariable getVariable(String variableName,
		...
		if (!System.getProperty(PROPERTY_OSNAME).toLowerCase(Locale.getDefault()).startsWith("windows ")) //$NON-NLS-1$ 
			return null;
		...
		if( configuration.getOwner() != null )
		{
			...
			if( prj != null )
			{
				String p = IdePlugin.getDefault().getSDKPath(prj) + IConstants.PATH_TOOLS + "\\Toolchains\\Win32\\bin";
